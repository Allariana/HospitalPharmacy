...
{
    public partial class AdministratorDepartmentsForm : Form
    {
        public AdministratorDepartmentsForm()
        {
            InitializeComponent();
        }
        ...
        private void AdministratorDepartmentsForm_Load(object sender, EventArgs e)
        {
